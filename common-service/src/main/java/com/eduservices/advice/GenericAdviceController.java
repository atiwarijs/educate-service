package com.eduservices.advice;

import com.eduservices.exception.AlreadyExistException;
...
public abstract class GenericAdviceController extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<?> handlePropertyReferenceException(PropertyReferenceException exception, WebRequest request){
        ProblemDetail errorDetail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(HttpStatus.INTERNAL_SERVER_ERROR.value()),
                "Invalid id property name used for sorting!");
    ...
    public ResponseEntity<?> handleAlreadyExistException( AlreadyExistException ex, WebRequest request) {
        ProblemDetail errorDetail = ProblemDetail.forStatusAndDetail(HttpStatusCode.valueOf(HttpStatus.FOUND.value()), "Already Exist!");
        errorDetail.setProperty("description", ex.getMessage());
        return new ResponseEntity<ProblemDetail>(errorDetail,HttpStatus.FOUND);
    }
