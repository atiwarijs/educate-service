...
import com.eduservices.security.dto.PasswordResetRequest;
import com.eduservices.security.dto.PasswordResetResponse;
...
public class PasswordResetService {
    ...
    public PasswordResetResponse sendPasswordResetLink(PasswordResetRequest request) {
        try {
            ...
            List<KeycloakUserDto> users = keycloakClient.getUsersByEmail(keycloakProperties.getRealm(), 
            ...
            return PasswordResetResponse.failure("An unexpected error occurred. Please try again later.");
        }
    }
    ...
    public PasswordResetResponse resetPassword(String token, String newPassword) {
        try {
            ...
            // Get user details
            KeycloakUserDto user = keycloakClient.getUserById(keycloakProperties.getRealm(), 
    ...
    private String getAdminAccessToken() {
        try {
            ...
            var tokenRequest = com.eduservices.profile.keycloak.TokenRequestDto.forClientCredentials(
                    keycloakProperties.getAdminClientId(),
                    keycloakProperties.getAdminClientSecret());
            
            var tokenResponse = keycloakClient.getToken(keycloakProperties.getAdminRealm(), tokenRequest);
            ...
            throw new RuntimeException("Keycloak admin service unavailable", e);
        }
    }
}
